...
function getPokemon(){
  ...
  fetch(url)
      ...
      .then(data => {
        console.log(data)
        document.querySelector('#player1-name').innerText = data.name.toUpperCase()
      ...
      .then(data => {
        console.log(data)
        document.querySelector('#player2-name').innerText = data.name.toUpperCase()
        document.querySelector('#player2-img').src = data.sprites.front_default
        document.querySelector('#player2-power').innerText = data.stats[i].base_stat 
        document.querySelector('#player2-type').innerText = data.types[0].type.name
